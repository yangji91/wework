...
public class HandleVideoMsg implements BaseHandleMsg {
    ...
    private void downloadImg(MsgEntity msgEntity){
        ...
        if ( videoMessage.videoId.length()==0&& videoMessage.url.length()>0 ) {//OSS文件
            ...
            new FileMessageService().downLoadLocalFile(contentType,  videoMessage.url,  videoMessage.videoId,  videoMessage.aesKey,  videoMessage.md5, videoMessage.md5
