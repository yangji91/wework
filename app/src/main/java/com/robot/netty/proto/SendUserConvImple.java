...
public class SendUserConvImple implements INettyTaskInte<TransmitData,TransmitData> {
    private final String TAG = getClass().getSimpleName();
    private TransmitData req;

    public SendUserConvImple(TransmitData req){
        this.req = req;
    }
